...
\subsubsection{Comparing the Workstealing and Pre-Balanced Benchmarks}
...
\subsubsection{Level-Wise Workstealing Benchmarks}
\begin{figure}[H]
...
\subsubsection{TCGA-1000 Benchmarks for both approaches}
