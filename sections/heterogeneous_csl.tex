...
Between each level the graph that contains the deleted edges of the last level has to be moved to the adjencency list representation used for reading existing edges. This step is called the compacting step \cite{zarebavaniCuPCCUDAbasedParallel2018}.
